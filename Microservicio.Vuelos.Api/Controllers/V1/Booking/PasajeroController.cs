...
[Route("api/v{version:apiVersion}/booking/pasajeros")]
...
public class PasajeroController : ControllerBase
{
    ...
    // CLIENTE no puede explorar pasajeros de otros usuarios
    [HttpGet]
    ...
    // CLIENTE lo usa para registrar a quienes viajan en su reserva (menores, terceros)
    [HttpPost]
    [Authorize(Roles = "ADMINISTRADOR,AEROLINEA,CLIENTE")] // ?
    ...
    public async Task<ActionResult<ApiResponse<PasajeroResponseDto>>> Create([FromBody] PasajeroRequestDto request)
    {
        ...
        return CreatedAtAction(
            ...
            ApiResponse<PasajeroResponseDto>.Ok(result, "Pasajero registrado correctamente."));
    }
